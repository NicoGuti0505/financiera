...
<form action="generar_pdf_viaticos.php" id="formulario" method="POST">
    <table>
        ...
        <td><input type="text" name="regional" id="regional" readonly></td>
            ...
            <td><input type="date" name="fecha_solicitud" id="fecha_solicitud"></td>
             <td><input type="text" name="radicado" id="radicado"></td>
    ...
    <td>Tipo y Número de Identificación:</td>
            ...
            <td>
                <select id="t_identificacion" name="t_identificacion" style="width: 180px;">
 ...
 <tr class="section-title">
    ...
    <tr>
        <td colspan="1">
                ...
                <td colspan="1">
                <label for="numero_idn">Numero de identificacion</label>
...
<tr class="section-title">
    ...
    <tr>
        <td colspan="1">N° identificación del titular de la cuenta bancaria</td>
        <td colspan="2"><input type="text" name="id_titular" id="id_titular"></td>
        <td>Tipo de Cuenta</td>
        <td>
            <select id="t_cuenta" name="t_cuenta" style="width: 180px;">
                <option value="">Cargando...</option>
            </select>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <select id="t_banco" name="t_banco" style="width: 180px;">
                <option value="">Cargando...</option>
            </select>
        </td>
...
<table>
    ...
    <td colspan="5"> Para el tramite de la solicitud se requiere adjuntar los soportes relacionados a continuación en formato PDF, legible sin enmendaduras ni tachones</td>
    <tr>
    ...
    <tr>
     <td colspan="2"><input type="checkbox" name="orden_medica" value="x">2. Copia de la orden medica del servicio asociado a la solicitud</td>
    ...
    <td colspan="1" style="padding-left: 70px;">  - Hospedaje
            ...
            <td colspan="2"><label for="Criterio_medico">Criterio medico</label><br><input type="checkbox" id="Criterio_medico" name="Criterio_medico" value="x"></td>
    ...
    <td colspan="3" style="padding-left: 70px;">  -Alimentación
            ...
            <td colspan="2" style="padding-right: 70px;"><label for="Alimentación_tute">Sólo en caso de Tutela</label><br><input type="checkbox" id="Alimentación_tute" name="Alimentación_tute" value="x"></td>
            <td colspan="2">
            <label for="c">valor</label>
    ...
    <tr>
    <td colspan="2" style="padding-left: 70px;">   viaticos
