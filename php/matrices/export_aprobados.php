...
while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
    ...
    $sheet->setCellValue('P' . $rowIndex, $row['banco']);
    $sheet->setCellValue('Q' . $rowIndex, $row['usuario_banco']);
    $sheet->setCellValue('R' . $rowIndex, $row['numero_identificacion']);
    $sheet->setCellValue('S' . $rowIndex, $row['numero_cuenta']);
    $sheet->setCellValue('T' . $rowIndex, $row['tipo_cuenta']);
    $sheet->setCellValue('U' . $rowIndex, $row['fecha_estado']->format('d/m/Y'));
...
header('Content-Disposition: attachment; filename="Matriz_Aprobados.xlsx"');
