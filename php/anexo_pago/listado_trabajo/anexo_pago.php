...
<body class="bg-gray-100 p-8">
    <div class="container">
        <h1 class="text-2xl font-bold mb-6 text-center">ANEXO DE PAGO</h1>
        
        <div class="flex space-x-4 mb-6">
        <div class="input-wrapper">
        <select  name="regionf_id" id="regionf_id">
        ...
        <input type="date" id="start_date" class="border p-2 rounded" placeholder="Fecha Inicial" value="<?php echo $fechaAnterior; ?>">
        <input type="date" id="end_date" class="border p-2 rounded" placeholder="Fecha Final" value="<?php echo $fechaActual; ?>">
        <button type="button" id="btnBuscar" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Buscar</button>
    </div>
    ...
    <script>
        const menuUrl = "<?php echo url('menu.php'); ?>";
    </script>
    <script src="<?php echo url('script/formato_texto.js'); ?>"></script>
    <script src="<?= url($RutaBase . 'js/anexo_pago.js'); ?>"></script>
</body>
</html>